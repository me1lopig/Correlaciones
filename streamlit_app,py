...
def main():
    ...
    LL = edited_df.loc[edited_df["Symbol"] == "LL", "Value"].values[0]
    PL = edited_df.loc[edited_df["Symbol"] == "PL", "Value"].values[0]
    IP = edited_df.loc[edited_df["Symbol"] == "IP", "Value"].values[0]
    w = edited_df.loc[edited_df["Symbol"] == "w", "Value"].values[0]
    e = edited_df.loc[edited_df["Symbol"] == "e", "Value"].values[0]
    Gs = edited_df.loc[edited_df["Symbol"] == "Gs", "Value"].values[0]
    F = edited_df.loc[edited_df["Symbol"] == "F", "Value"].values[0]
